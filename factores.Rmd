...
# Para ver mejor algunos resultados
options(pillar.print_max = 16)
```
...
Presenta: **Jan Strappa** ([jansf.netlify.app](jansf.netlify.app))

Capítulo: **15. Factores** [https://es.r4ds.hadley.nz/factores.html](https://es.r4ds.hadley.nz/factores.html)
...
‘stringsAsFactors’ es un argumento de la función ‘data.frame()’. 
...
Actualmente, muchas funciones no realizan coerción de cadenas a factores, por ejemplo, `readr`^[https://peerj.com/preprints/3163/].
...
### Se pueden definir niveles definidos en base a su aparición en los datos:
...
**PREGUNTA: ¿Cómo podemos mejorar este gráfico? _(Similar a Ejercicio 15.3.1.1)_ 💬**
